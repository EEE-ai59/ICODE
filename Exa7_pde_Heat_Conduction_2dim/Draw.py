...
with open(filename, 'rb') as file:
    ...
    lossStep=loaded_instance.lossStep
...
if run_CDE:
    ax.plot(msePredStep[:draw_len], msePred_c_mean[:draw_len], color=rgb_color_c, label='CDE', marker='.', markevery=int(num_epochs/4))
if run_NeuralODE:
    ax.plot(msePredStep[:draw_len], msePred_n_mean[:draw_len], color=rgb_color_n, label='NODE', marker='+', markevery=int(num_epochs/6))
if run_AugNeuralODE:
    ax.plot(msePredStep[:draw_len], msePred_aug_mean[:draw_len], color=rgb_color_aug, label='ANODE', marker='x', markevery=int(num_epochs/3))
...
fig_file=fig_path+'/heatPDE-testError.svg'
...
if run_my:
    ax.plot(lossStep[:draw_len], Loss_cs_mean[:draw_len], color=rgb_color_cs, label='ICODE', linewidth=2, marker='*', markevery=int(num_epochs/5))
if run_CDE:
    ax.plot(lossStep[:draw_len], Loss_c_mean[:draw_len], color=rgb_color_c, label='CDE', marker='.', markevery=int(num_epochs/4))
if run_NeuralODE:
    ax.plot(lossStep[:draw_len], Loss_n_mean[:draw_len], color=rgb_color_n, label='NODE', marker='+', markevery=int(num_epochs/6))
if run_AugNeuralODE:
    ax.plot(lossStep[:draw_len], Loss_aug_mean[:draw_len], color=rgb_color_aug, label='ANODE', marker='x', markevery=int(num_epochs/3))
ax.set_xlabel('Epoch', fontsize=fontsize_xylabel)
...
# ax.grid(color='w')
# ax.set_ylim([0, 0.5])
fig_file=fig_path+'/heatPDE-trainError.svg'
plt.savefig(fig_file, format='svg')
fig_file=fig_path+'/heatPDE-trainError.png'
plt.savefig(fig_file, dpi=300)
plt.show()
