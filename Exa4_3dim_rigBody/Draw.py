...
fig_file=fig_path+'/rigBody-testError.svg'
plt.savefig(fig_file, format='svg')
fig_file=fig_path+'/rigBody-testError.png'
...
fig_file=fig_path+'/rigBody-trainError.svg'
plt.savefig(fig_file, format='svg')
fig_file=fig_path+'/rigBody-trainError.png'
plt.savefig(fig_file, dpi=300)
plt.show()
